    ...
    const csvRows = [
      ...
      ...orders.map(order => {
        ...
        const supplierName = supplierInfo 
          ? (supplierInfo.shop_name_on_zambeel || supplierInfo.shop_name || supplierInfo.email || 'Unknown')
          : ''
                  ...
                  >
                    ...
                    {suppliers.map(supplier => (
                      <option key={supplier.user_id} value={supplier.user_id}>
                        {supplier.shop_name_on_zambeel || supplier.shop_name || supplier.email}
                      </option>
                    ))}
                  </select>
                </div>
                          ...
                          {(userRole === 'purchaser' || userRole === 'admin') && (
                            <td className="px-6 py-4">
                              <div className="text-sm text-gray-900">
                                {supplierInfo ? (
                                  <div>
                                    <div className="font-medium">{supplierInfo.shop_name_on_zambeel || supplierInfo.shop_name || 'Unnamed'}</div>
                                  </div>
                                ) : (
